...
let firstFormBtn = document.querySelector('[href="firstForm"]');
let secondFormBtn = document.querySelector('[href="secondForm"]');
let thirdFormBtn = document.querySelector('[href="thirdForm"]');
let forthFormBtn = document.querySelector('[href="forthForm"]');
let fifthFormBtn = document.querySelector('[href="fifthForm"]');
...
firstFormBtn.addEventListener('click',function(e){
    e.preventDefault();
...
secondFormBtn.addEventListener('click',function(e){
    e.preventDefault();
...
thirdFormBtn.addEventListener('click',function(e){
    e.preventDefault();
    member.style.display = "none";
    friend.style.display = "none";
...
forthFormBtn.addEventListener('click',function(e){
    e.preventDefault();
    member.style.display = "none";
    friend.style.display = "none";
    shrine.style.display = "none";
...
fifthFormBtn.addEventListener('click',function(e){
    e.preventDefault();
    member.style.display = "block";
    friend.style.display = "none";
    shrine.style.display = "none";
